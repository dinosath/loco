...
ReactDOM.createRoot(document.getElementById('root')).render(
    <React.StrictMode>
      ...
      <div className="logo">
        ...
        <p>Welcome!</p>
        <a href="https://accounts.google.com/o/oauth2/v2/auth?scope=openid%20profile%20email&client_id=124259729144-gjnjj2ocaiisicgiq88mur3f7i5u9abk.apps.googleusercontent.com&response_type=code&redirect_uri=http://localhost:3000/auth/google_callback">
